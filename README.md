...
Pull requests into `dev` receive an automatic Codex review. A developer evaluates
the findings and pushes any fixes before manually starting **Technical
Verification** from the GitHub Actions page for the pull request branch. Pushing a
fix starts a fresh Codex review; it does not start CI.
...
3. Keep the Codex review informational; do not configure it as a required status
